...
namespace WIKI.WebApi
{
    public class ODataConfig
    {
        public static void RegisterOData(HttpConfiguration config)
        {
            ...
            var searchTagAction = builder.EntityType<Tag>().Collection.Action("Search");
            searchTagAction.Parameter<System.Web.OData.Query.ODataQueryOptions<Tag>>("queryOptions");
            searchTagAction.ReturnsCollectionFromEntitySet<Tag>("Tag");
